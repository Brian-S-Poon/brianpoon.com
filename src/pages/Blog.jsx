...
export default function Blog() {
  return (
    <>
      <Helmet>
        <title>Blog – Brian Poon</title>
        <meta name="description" content="Thoughts and writings by Brian Poon." />
        <meta property="og:title" content="Blog – Brian Poon" />
        <meta property="og:description" content="Thoughts and writings by Brian Poon." />
      </Helmet>
      <Motion.section
