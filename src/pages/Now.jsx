...
export default function Now() {
  return (
    <>
      <Helmet>
        <title>Now – Brian Poon</title>
        <meta name="description" content="What Brian Poon is working on right now." />
        <meta property="og:title" content="Now – Brian Poon" />
        <meta property="og:description" content="What Brian Poon is working on right now." />
      </Helmet>
      <Motion.section
